    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("43cb9f67-8568-4a8d-81c6-110a622787bb"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(97), 0, 0, "Countries with most homicides per 100,000 people", "Top 10" },
                    { new Guid("f5b97548-cb81-44b5-8830-aba39f71c079"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(102), 0, 0, "What are the countries with the highest murder count per year", "Top 10" },
                    { new Guid("9cafb85f-730b-4a26-a661-b2d2dda74534"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(106), 0, 0, "What countries have the highest fertility rate (2019)", "Top 10" },
                    { new Guid("9429778e-df46-4c10-a0d4-80fecbfdf3f9"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(111), 0, 0, "What countries have the lowest fertility rate (2019)", "Top 10" },
                    { new Guid("62732694-8646-4ded-a4ac-c51dfce4dfc6"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(116), 0, 0, "What countries have won the most gold medals at the olympics", "Top 10" },
                    { new Guid("db0edb42-f12b-432f-82ec-5d16a51f13f0"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(120), 0, 0, "What countries have the most amount of total immigrants", "Top 10" },
                    { new Guid("03744a50-cdd5-43c1-898d-b69df8168820"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(125), 0, 0, "What countries have the most percentage of immigrants", "Top 10" },
                    { new Guid("961761d2-f15d-4853-b8f9-91b9745be1b8"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(129), 0, 0, "What are the countries that drink the most beer per capita", "Top 10" },
                    { new Guid("4cfea5e6-dec6-40ea-8d7e-6f8034a45b82"), 4, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(134), 0, 0, "What are the countries with the most unesco world heritage sites", "Top 10" },
                    { new Guid("94e5f344-ef61-44c6-b209-9b805ca42880"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(139), 0, 0, "What are the most visited countries in the world (2019)", "Top 10" },
                    { new Guid("3e7b6791-8e14-4284-8201-87d7ddc0850b"), 2, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(144), 0, 0, "What countries have the most billionaires (2021)", "Top 10" },
                    { new Guid("f6d70c09-f3a9-4c9e-8baf-808916af4291"), 2, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(149), 0, 0, "What countries have the most millionaires (2021)", "Top 10" },
                    { new Guid("f1b44064-927d-45bf-9fe4-14c2d98d774c"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(93), 0, 0, "What are the countries with the oldest median age (2020)", "Top 10" },
                    { new Guid("e75284fe-a777-4d85-aad5-e68b817b2d50"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(89), 0, 0, "What are the countries with the youngest median age (2020)", "Top 10" },
                    { new Guid("00437064-4748-470c-b77e-046703a2a19a"), 6, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(84), 0, 0, "What are the newest countries in the world", "Top 10" },
                    { new Guid("1f56b20c-54b1-40a3-9b60-c510f27912ae"), 6, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(77), 0, 0, "What are the first countries if you order them alphabetically (A-Z)", "Top 10" },
                    { new Guid("6e9f33c2-9bd1-4c4d-b508-c09fd13d6040"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(72), 0, 0, "What are the most obese countries of the world (2016)", "Top 10" },
                    { new Guid("59dddd6c-7a6e-4e43-9869-088ef430421f"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(68), 0, 0, "Which countries spend the most on their military", "Top 10" },
                    { new Guid("5a563a77-0a11-459a-8162-d886acf1f898"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(63), 0, 0, "What are the least happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("5c08cfa3-a2e0-43bd-a574-184cb3bde2d2"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(59), 0, 0, "What countries have the highest prison population", "Top 10" },
                    { new Guid("26775c7d-97ea-415d-b73c-7629759656cf"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(54), 0, 0, "What countries have the highest GDP per capita", "Top 10" },
                    { new Guid("8630be8d-b3e3-4b1e-babc-207819fe2f46"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(50), 0, 0, "What countries have the highest GDP (nominal)", "Top 10" },
                    { new Guid("962c9cae-4ba2-4506-98c2-1ccdd9535b40"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(45), 0, 0, "What countries have the biggest population of catholics", "Top 10" },
                    { new Guid("98220fe9-135d-423b-ab8f-14d57eafcb38"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(40), 0, 0, "What countries have the biggest population of muslims", "Top 10" },
                    { new Guid("3aa5a782-c701-4a75-b4f0-98bab8d144e2"), 3, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(35), 0, 0, "What are the happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613"), 6, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(27), 0, 0, "What are the smallest countries of the world", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), 4, new DateTime(2021, 8, 19, 17, 15, 10, 182, DateTimeKind.Local).AddTicks(9951), 0, 0, "What countries have the biggest population", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000001"), 6, new DateTime(2021, 8, 19, 17, 15, 10, 180, DateTimeKind.Local).AddTicks(1670), 0, 0, "What are the biggest countries of the world", "Top 10" },
                    { new Guid("7301c840-a51f-4e7e-9ead-a5d8e50d510b"), 6, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(153), 0, 0, "Who were the first ten presidents of the United States", "Top 10" },
                    { new Guid("da899e4f-63f2-4560-b693-1c1f13a17d13"), 5, new DateTime(2021, 8, 19, 17, 15, 10, 183, DateTimeKind.Local).AddTicks(158), 0, 0, "Who were the last ten presidents of the United States", "Top 10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("85ffa2cb-c8d1-40a3-88e6-b0753a80edd3"), "Russia", "17,098,242 Km²", 1, 1, new Guid("00000000-0000-0000-0000-000000000001") },
                    ...
                    { new Guid("9768259f-3a93-4088-85fb-5855dbd599de"), "Mexico", "128,932,753", 10, 10, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("9541e0b2-6dce-4633-85a2-38f81b0ef4a1"), "Russia", "145,934,462", 9, 9, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("c36b46a9-fdf0-4e51-abf1-1da04d134b07"), "Bangladesh", "164,689,383", 8, 8, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("75e4daff-b975-44e6-9148-bcbee1188809"), "Nigeria", "206,139,589", 7, 7, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("e22e7a22-e266-49d4-a1ce-8d9697a7c26d"), "Brazil", "212,559,417", 6, 6, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("7337fdef-727b-4914-ad1b-ae8b5c2f653d"), "Pakistan", "220,892,340", 5, 5, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("e0914ddd-ed8f-4943-9b98-b2720e8454d8"), "Indonesia", "273,523,615", 4, 4, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("1e32cd1a-93b3-44bc-afbe-9a53a772582e"), "United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("cb185717-7c11-4fb1-8b98-a00d4c97b133"), "US", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("4615fe0e-a814-4458-9704-35e67bdf79a5"), "USA", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("26ad01ed-ff4e-488a-8075-f38e0a53dd1c"), "Vatican City", "0.49 Km²", 1, 1, new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613") },
                    { new Guid("ae3d3634-bab2-49cb-8eea-207b9e74d3bc"), "India", "1,380,004,385", 2, 2, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("71fddb89-3d92-4448-82b2-93a86dd1ed30"), "Algeria", "2,381,740 Km²", 10, 10, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("2de552c0-edc8-41a6-a65a-cad98ae30c52"), "Kazakhstan", "2,724,900 Km²", 9, 9, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("72fefdaf-8c63-435a-a0d2-3471ab7b81da"), "Argentina", "2,780,400 Km²", 8, 8, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("9b088d2c-33e0-4339-9947-ea03a71d6ec5"), "India", "3,287,263 Km²", 7, 7, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("8f7dfbe1-4467-4362-9eca-aa8dd1a74d17"), "Australia", "7,741,220 Km²", 6, 6, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("3a577fe1-fbad-41ec-b85a-303471b88584"), "Brazil", "8,515,770 Km²", 5, 5, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("7ab8d928-200f-4d33-b2c4-1b91bf457c4d"), "China", "9,596,960 Km²", 4, 4, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("940b818b-a3ec-4a01-8936-630c16f25e5b"), "United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("32c637f4-5719-4f58-8c6b-d3a267cd4641"), "US", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("17bdd856-3fc8-44d6-a0ba-d8de95ef5018"), "USA", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("b6b7dcb1-3409-461c-96f9-70cd2a052e7b"), "Canada", "9,984,670 Km²", 2, 2, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("0d2fb276-4fd5-469c-af9c-96704b59e393"), "China", "1,439,323,776", 1, 1, new Guid("00000000-0000-0000-0000-000000000002") },
