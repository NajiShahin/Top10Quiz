        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionStart = table.Column<DateTime>(nullable: false),
                    QuestionEnd = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("43cb9f67-8568-4a8d-81c6-110a622787bb"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2004), 0, 0, "Countries with most homicides per 100,000 people", "Top 10" },
                    { new Guid("f5b97548-cb81-44b5-8830-aba39f71c079"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2008), 0, 0, "What are the countries with the highest murder count per year", "Top 10" },
                    { new Guid("9cafb85f-730b-4a26-a661-b2d2dda74534"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2012), 0, 0, "What countries have the highest fertility rate (2019)", "Top 10" },
                    { new Guid("9429778e-df46-4c10-a0d4-80fecbfdf3f9"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2016), 0, 0, "What countries have the lowest fertility rate (2019)", "Top 10" },
                    { new Guid("62732694-8646-4ded-a4ac-c51dfce4dfc6"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2021), 0, 0, "What countries have won the most gold medals at the olympics", "Top 10" },
                    { new Guid("db0edb42-f12b-432f-82ec-5d16a51f13f0"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2025), 0, 0, "What countries have the most amount of total immigrants", "Top 10" },
                    { new Guid("03744a50-cdd5-43c1-898d-b69df8168820"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2029), 0, 0, "What countries have the most percentage of immigrants", "Top 10" },
                    { new Guid("961761d2-f15d-4853-b8f9-91b9745be1b8"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2034), 0, 0, "What are the countries that drink the most beer per capita", "Top 10" },
                    { new Guid("4cfea5e6-dec6-40ea-8d7e-6f8034a45b82"), 4, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2038), 0, 0, "What are the countries with the most unesco world heritage sites", "Top 10" },
                    { new Guid("94e5f344-ef61-44c6-b209-9b805ca42880"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2043), 0, 0, "What are the most visited countries in the world (2019)", "Top 10" },
                    { new Guid("3e7b6791-8e14-4284-8201-87d7ddc0850b"), 2, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2048), 0, 0, "What countries have the most billionaires (2021)", "Top 10" },
                    { new Guid("f6d70c09-f3a9-4c9e-8baf-808916af4291"), 2, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2052), 0, 0, "What countries have the most millionaires (2021)", "Top 10" },
                    { new Guid("f1b44064-927d-45bf-9fe4-14c2d98d774c"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1999), 0, 0, "What are the countries with the oldest median age (2020)", "Top 10" },
                    { new Guid("e75284fe-a777-4d85-aad5-e68b817b2d50"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1995), 0, 0, "What are the countries with the youngest median age (2020)", "Top 10" },
                    { new Guid("00437064-4748-470c-b77e-046703a2a19a"), 6, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1991), 0, 0, "What are the newest countries in the world", "Top 10" },
                    { new Guid("1f56b20c-54b1-40a3-9b60-c510f27912ae"), 6, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1986), 0, 0, "What are the first countries if you order them alphabetically (A-Z)", "Top 10" },
                    { new Guid("6e9f33c2-9bd1-4c4d-b508-c09fd13d6040"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1982), 0, 0, "What are the most obese countries of the world (2016)", "Top 10" },
                    { new Guid("59dddd6c-7a6e-4e43-9869-088ef430421f"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1977), 0, 0, "Which countries spend the most on their military", "Top 10" },
                    { new Guid("5a563a77-0a11-459a-8162-d886acf1f898"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1972), 0, 0, "What are the least happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("5c08cfa3-a2e0-43bd-a574-184cb3bde2d2"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1967), 0, 0, "What countries have the highest prison population", "Top 10" },
                    { new Guid("26775c7d-97ea-415d-b73c-7629759656cf"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1962), 0, 0, "What countries have the highest GDP per capita", "Top 10" },
                    { new Guid("8630be8d-b3e3-4b1e-babc-207819fe2f46"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1957), 0, 0, "What countries have the highest GDP (nominal)", "Top 10" },
                    { new Guid("962c9cae-4ba2-4506-98c2-1ccdd9535b40"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1907), 0, 0, "What countries have the biggest population of catholics", "Top 10" },
                    { new Guid("98220fe9-135d-423b-ab8f-14d57eafcb38"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1902), 0, 0, "What countries have the biggest population of muslims", "Top 10" },
                    { new Guid("3aa5a782-c701-4a75-b4f0-98bab8d144e2"), 3, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1897), 0, 0, "What are the happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613"), 6, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1890), 0, 0, "What are the smallest countries of the world", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), 4, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(1829), 0, 0, "What countries have the biggest population", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000001"), 6, new DateTime(2021, 8, 18, 15, 4, 8, 520, DateTimeKind.Local).AddTicks(5473), 0, 0, "What are the biggest countries of the world", "Top 10" },
                    { new Guid("7301c840-a51f-4e7e-9ead-a5d8e50d510b"), 6, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2056), 0, 0, "Who were the first ten presidents of the United States", "Top 10" },
                    { new Guid("da899e4f-63f2-4560-b693-1c1f13a17d13"), 5, new DateTime(2021, 8, 18, 15, 4, 8, 523, DateTimeKind.Local).AddTicks(2061), 0, 0, "Who were the last ten presidents of the United States", "Top 10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("463bbf10-26aa-4693-b336-b6b11e107739"), "Russia", "17,098,242 Km²", 1, 1, new Guid("00000000-0000-0000-0000-000000000001") },
                    ...
                    { new Guid("58eba24f-3f17-4a04-82ba-dfe041aca266"), "Mexico", "128,932,753", 10, 10, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("9309c852-d294-4c2d-92c4-f2cd33d15ead"), "Russia", "145,934,462", 9, 9, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("274d615e-78ce-44a4-953e-48f041b20752"), "Bangladesh", "164,689,383", 8, 8, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("099a0a2f-bce5-46e6-82dc-c4f5ce395f7e"), "Nigeria", "206,139,589", 7, 7, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("73e04eec-3154-46ae-9f25-0a0e75cae17c"), "Brazil", "212,559,417", 6, 6, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("2bdc5a7e-bc8c-4eb0-adbf-cfa05a3547cf"), "Pakistan", "220,892,340", 5, 5, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("a3a765e3-d221-46a0-bf1b-5be82044a795"), "Indonesia", "273,523,615", 4, 4, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("59805063-ff49-4607-a3f6-c77dfb004357"), "United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("e87b0222-2fab-4e51-a50a-fe59b6f0f988"), "US", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("d9093f04-6665-4488-aed1-5c69cc390a35"), "USA", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("26ad01ed-ff4e-488a-8075-f38e0a53dd1c"), "Vatican City", "0.49 Km²", 1, 1, new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613") },
                    { new Guid("fd524af1-71b9-424b-9c3f-a1fe09cd35d1"), "India", "1,380,004,385", 2, 2, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("7e61124a-4020-4867-8d06-5dada8520c27"), "Algeria", "2,381,740 Km²", 10, 10, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("5d4ed9a9-98ff-4960-9039-d3010586dee4"), "Kazakhstan", "2,724,900 Km²", 9, 9, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("b47981b5-e718-48e8-ac7c-48ab32387f32"), "Argentina", "2,780,400 Km²", 8, 8, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("2519b33d-8444-4e3d-9caf-d983092cfe9c"), "India", "3,287,263 Km²", 7, 7, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("1ca0443d-8c95-4d4e-904a-9790c480f828"), "Australia", "7,741,220 Km²", 6, 6, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("0d805348-231b-41a9-a2ec-3cdcd45cb853"), "Brazil", "8,515,770 Km²", 5, 5, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("58c50211-d646-4d32-aa70-81148522598f"), "China", "9,596,960 Km²", 4, 4, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("0387c55c-674c-4f1a-9b42-d815098062f5"), "United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("ab332c35-130c-4a99-9848-bedcb0a656da"), "US", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("fb7ac6f7-6c39-44d3-883f-ed84eb638d4a"), "USA", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("bcfcc960-8854-41fe-af2c-0b2f662b62ba"), "Canada", "9,984,670 Km²", 2, 2, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("2f652e02-29a7-4d7a-85a9-9d2b7395ed8e"), "China", "1,439,323,776", 1, 1, new Guid("00000000-0000-0000-0000-000000000002") },
