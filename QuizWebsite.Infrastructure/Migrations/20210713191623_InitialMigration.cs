...
namespace QuizWebsite.Infrastructure.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "QuestionText", "QuestionType" },
                values: new object[,]
                {
                    { new Guid("f5b97548-cb81-44b5-8830-aba39f71c079"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the countries with the highest murder count per year", "Top 10" },
                    { new Guid("43cb9f67-8568-4a8d-81c6-110a622787bb"), new Guid("00000000-0000-0000-0000-000000000000"), "Countries with most homocides per 100,000 people", "Top 10" },
                    { new Guid("f1b44064-927d-45bf-9fe4-14c2d98d774c"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the countries with the oldest median age (2020)", "Top 10" },
                    { new Guid("e75284fe-a777-4d85-aad5-e68b817b2d50"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the countries with the youngest median age (2020)", "Top 10" },
                    { new Guid("00437064-4748-470c-b77e-046703a2a19a"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the newest countries in the world", "Top 10" },
                    { new Guid("1f56b20c-54b1-40a3-9b60-c510f27912ae"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the first countries if you order them alphabetically (A-Z)", "Top 10" },
                    { new Guid("6e9f33c2-9bd1-4c4d-b508-c09fd13d6040"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the most obese countries of the world (2016)", "Top 10" },
                    { new Guid("59dddd6c-7a6e-4e43-9869-088ef430421f"), new Guid("00000000-0000-0000-0000-000000000000"), "Which countries spend the most on their military", "Top 10" },
                    { new Guid("9cafb85f-730b-4a26-a661-b2d2dda74534"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the highest fertility rate (2019)", "Top 10" },
                    { new Guid("5a563a77-0a11-459a-8162-d886acf1f898"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the least happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("26775c7d-97ea-415d-b73c-7629759656cf"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the highest GDP per capita", "Top 10" },
                    { new Guid("8630be8d-b3e3-4b1e-babc-207819fe2f46"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the highest GDP (nominal)", "Top 10" },
                    { new Guid("962c9cae-4ba2-4506-98c2-1ccdd9535b40"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the biggest population of catholics", "Top 10" },
                    { new Guid("98220fe9-135d-423b-ab8f-14d57eafcb38"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the biggest population of muslims", "Top 10" },
                    { new Guid("3aa5a782-c701-4a75-b4f0-98bab8d144e2"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the smallest countries of the world", "Top10" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the biggest population", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000001"), new Guid("00000000-0000-0000-0000-000000000000"), "What are the biggest countries of the world", "Top 10" },
                    { new Guid("5c08cfa3-a2e0-43bd-a574-184cb3bde2d2"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the highest prison population", "Top 10" },
                    { new Guid("9429778e-df46-4c10-a0d4-80fecbfdf3f9"), new Guid("00000000-0000-0000-0000-000000000000"), "What countries have the lowest fertility rate (2019)", "Top 10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("bffe8a72-8073-4ada-92ed-1e4c32b255fd"), "Russia", "17,098,242 Km²", 1, 1, new Guid("00000000-0000-0000-0000-000000000001") },
                    ...
                    { new Guid("bc99ff80-9474-4d2c-8271-bf7c74fec633"), "Canada", "9,984,670 Km²", 2, 2, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("1229746c-3170-4cfb-81c1-1e20283d739a"), "USA", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("95545a70-2339-4498-bb5b-76a7ee86c249"), "The United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("feb848ca-4c97-43d7-a272-11f9106a96c9"), "United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("747d71a8-9c20-47b4-bce5-8fb69764f687"), "China", "9,596,960 Km²", 4, 4, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("dacc8489-7392-4096-92dd-15bdf7262687"), "Brazil", "8,515,770 Km²", 5, 5, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("e2f66f44-0fed-40f8-96b1-6ea9bb6381c8"), "Australia", "7,741,220 Km²", 6, 6, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("37977a17-77a6-4564-80cd-b41653fcfd42"), "India", "3,287,263 Km²", 7, 7, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("4997302a-4469-48df-b381-f6928852888b"), "Argentina", "2,780,400 Km²", 8, 8, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("bd3b4d5a-5f98-4b48-ae7e-57ad7a21d54c"), "Kazakhstan", "2,724,900 Km²", 9, 9, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("be5b90c2-404e-4ed2-81c1-0c8de5e733fc"), "Algeria", "2,381,740 Km²", 10, 10, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("d32c4a73-6cbe-44c2-8e06-e89fe08f2e1c"), "China", "1,439,323,776", 1, 1, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("8c0d283b-2d46-4c30-8d7b-e94282082c56"), "India", "1,380,004,385", 2, 2, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("940e5dd2-0cd4-4281-b74f-acdb4a732c35"), "USA", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("661228e7-3c62-41ca-861a-a014ae55b4ff"), "The United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("afa30840-1f82-4b97-94a9-2b7464bdccd6"), "United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("f7d55c33-5111-442d-baeb-0d522c72faf7"), "Indonesia", "273,523,615", 4, 4, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("a9af6cbe-fd9a-407c-8bd5-c50e3db6efb1"), "Pakistan", "220,892,340", 5, 5, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("7db6352f-5aec-405c-bd9d-707ddc556571"), "Brazil", "212,559,417", 6, 6, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("249f2a24-79e0-4784-9299-2da08a1633d8"), "Nigeria", "206,139,589", 7, 7, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("b8cd6ccc-16e1-4544-8f69-62eced557eda"), "Bangladesh", "164,689,383", 8, 8, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("6eebefcd-1845-4983-a598-055b18aa76af"), "Russia", "145,934,462", 9, 9, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("bba1457f-4536-42dd-bd45-a61d918e61bb"), "Mexico", "128,932,753", 10, 10, new Guid("00000000-0000-0000-0000-000000000002") },
