    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("43cb9f67-8568-4a8d-81c6-110a622787bb"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2122), 0, 0, "Countries with most homicides per 100,000 people", "Top 10" },
                    { new Guid("f5b97548-cb81-44b5-8830-aba39f71c079"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2126), 0, 0, "What are the countries with the highest murder count per year", "Top 10" },
                    { new Guid("9cafb85f-730b-4a26-a661-b2d2dda74534"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2131), 0, 0, "What countries have the highest fertility rate (2019)", "Top 10" },
                    { new Guid("9429778e-df46-4c10-a0d4-80fecbfdf3f9"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2135), 0, 0, "What countries have the lowest fertility rate (2019)", "Top 10" },
                    { new Guid("62732694-8646-4ded-a4ac-c51dfce4dfc6"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2140), 0, 0, "What countries have won the most gold medals at the olympics", "Top 10" },
                    { new Guid("db0edb42-f12b-432f-82ec-5d16a51f13f0"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2145), 0, 0, "What countries have the most amount of total immigrants", "Top 10" },
                    { new Guid("03744a50-cdd5-43c1-898d-b69df8168820"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2149), 0, 0, "What countries have the most percentage of immigrants", "Top 10" },
                    { new Guid("961761d2-f15d-4853-b8f9-91b9745be1b8"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2153), 0, 0, "What are the countries that drink the most beer per capita", "Top 10" },
                    { new Guid("4cfea5e6-dec6-40ea-8d7e-6f8034a45b82"), 4, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2158), 0, 0, "What are the countries with the most unesco world heritage sites", "Top 10" },
                    { new Guid("94e5f344-ef61-44c6-b209-9b805ca42880"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2163), 0, 0, "What are the most visited countries in the world (2019)", "Top 10" },
                    { new Guid("3e7b6791-8e14-4284-8201-87d7ddc0850b"), 2, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2168), 0, 0, "What countries have the most billionaires (2021)", "Top 10" },
                    { new Guid("f6d70c09-f3a9-4c9e-8baf-808916af4291"), 2, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2172), 0, 0, "What countries have the most millionaires (2021)", "Top 10" },
                    { new Guid("f1b44064-927d-45bf-9fe4-14c2d98d774c"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2117), 0, 0, "What are the countries with the oldest median age (2020)", "Top 10" },
                    { new Guid("e75284fe-a777-4d85-aad5-e68b817b2d50"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2113), 0, 0, "What are the countries with the youngest median age (2020)", "Top 10" },
                    { new Guid("00437064-4748-470c-b77e-046703a2a19a"), 6, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2108), 0, 0, "What are the newest countries in the world", "Top 10" },
                    { new Guid("1f56b20c-54b1-40a3-9b60-c510f27912ae"), 6, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2103), 0, 0, "What are the first countries if you order them alphabetically (A-Z)", "Top 10" },
                    { new Guid("6e9f33c2-9bd1-4c4d-b508-c09fd13d6040"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2098), 0, 0, "What are the most obese countries of the world (2016)", "Top 10" },
                    { new Guid("59dddd6c-7a6e-4e43-9869-088ef430421f"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2094), 0, 0, "Which countries spend the most on their military", "Top 10" },
                    { new Guid("5a563a77-0a11-459a-8162-d886acf1f898"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2089), 0, 0, "What are the least happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("5c08cfa3-a2e0-43bd-a574-184cb3bde2d2"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2084), 0, 0, "What countries have the highest prison population", "Top 10" },
                    { new Guid("26775c7d-97ea-415d-b73c-7629759656cf"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2079), 0, 0, "What countries have the highest GDP per capita", "Top 10" },
                    { new Guid("8630be8d-b3e3-4b1e-babc-207819fe2f46"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2075), 0, 0, "What countries have the highest GDP (nominal)", "Top 10" },
                    { new Guid("962c9cae-4ba2-4506-98c2-1ccdd9535b40"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2069), 0, 0, "What countries have the biggest population of catholics", "Top 10" },
                    { new Guid("98220fe9-135d-423b-ab8f-14d57eafcb38"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2065), 0, 0, "What countries have the biggest population of muslims", "Top 10" },
                    { new Guid("3aa5a782-c701-4a75-b4f0-98bab8d144e2"), 3, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2060), 0, 0, "What are the happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613"), 6, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2052), 0, 0, "What are the smallest countries of the world", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), 4, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(1940), 0, 0, "What countries have the biggest population", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000001"), 6, new DateTime(2021, 8, 5, 15, 21, 33, 565, DateTimeKind.Local).AddTicks(2085), 0, 0, "What are the biggest countries of the world", "Top 10" },
                    { new Guid("7301c840-a51f-4e7e-9ead-a5d8e50d510b"), 6, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2176), 0, 0, "Who were the first ten presidents of the United States", "Top 10" },
                    { new Guid("da899e4f-63f2-4560-b693-1c1f13a17d13"), 5, new DateTime(2021, 8, 5, 15, 21, 33, 568, DateTimeKind.Local).AddTicks(2180), 0, 0, "Who were the last ten presidents of the United States", "Top 10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("f42d8f43-5b7c-455d-978d-a635a07ab53b"), "Russia", "17,098,242 Km²", 1, 1, new Guid("00000000-0000-0000-0000-000000000001") },
                    ...
                    { new Guid("f894b8d8-e10f-4604-8f59-ddd64e9c52ef"), "Mexico", "128,932,753", 10, 10, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("e5b816b1-7580-465e-90f9-62af44e3555a"), "Russia", "145,934,462", 9, 9, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("80764afd-9d93-4798-a68d-e0302f972b8f"), "Bangladesh", "164,689,383", 8, 8, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("945af626-c6a5-4ec9-b44e-2b3fde96dff7"), "Nigeria", "206,139,589", 7, 7, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("782cf576-405b-4858-996e-3685a962f5ba"), "Brazil", "212,559,417", 6, 6, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("d139a446-dd76-4c2c-87b2-5c21e394bb14"), "Pakistan", "220,892,340", 5, 5, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("b67cd5d0-fc45-4ca5-ab7b-da00ee44e714"), "Indonesia", "273,523,615", 4, 4, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("2522a718-d090-4afc-92bc-42a07eb50756"), "United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("f81ac641-54e6-468c-a381-bcbb2c4414ab"), "US", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("23f214bf-a2f4-4b90-92a6-bc265e3f27d2"), "USA", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("26ad01ed-ff4e-488a-8075-f38e0a53dd1c"), "Vatican City", "0.49 Km²", 1, 1, new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613") },
                    { new Guid("1f43c378-bf28-406c-90ad-5736fd28cdee"), "India", "1,380,004,385", 2, 2, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("82a26293-6428-4194-a16d-4a3b6e689b1a"), "Algeria", "2,381,740 Km²", 10, 10, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("12d55c67-87b3-4e72-8d23-f57a5e3d7a9f"), "Kazakhstan", "2,724,900 Km²", 9, 9, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("75621d96-1014-48d4-ad18-f97670afe31b"), "Argentina", "2,780,400 Km²", 8, 8, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("c9426cf6-b489-4bfb-a01a-454d7cf289c1"), "India", "3,287,263 Km²", 7, 7, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("8c403bc9-da40-4ca4-a12c-551096712e33"), "Australia", "7,741,220 Km²", 6, 6, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("f3b9b244-0996-489f-8f9f-d0a02b6e6b07"), "Brazil", "8,515,770 Km²", 5, 5, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("4f2359ac-111d-47c6-94d5-434fc54a5654"), "China", "9,596,960 Km²", 4, 4, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("ffe439ea-d06f-4b50-a9a9-2b4489379d5c"), "United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("8334dd6b-096a-4e3f-b572-1f9c884896e6"), "US", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("8612651c-e6a1-4ea7-8331-9d2c5e642304"), "USA", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("60896272-f6b9-4b80-862c-506686fd07b2"), "Canada", "9,984,670 Km²", 2, 2, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("044b7d32-3ba6-4e38-92a7-6aef0e2e666a"), "China", "1,439,323,776", 1, 1, new Guid("00000000-0000-0000-0000-000000000002") },
