    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("43cb9f67-8568-4a8d-81c6-110a622787bb"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1215), 0, 0, "Countries with most homicides per 100,000 people", "Top 10" },
                    { new Guid("f5b97548-cb81-44b5-8830-aba39f71c079"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1219), 0, 0, "What are the countries with the highest murder count per year", "Top 10" },
                    { new Guid("9cafb85f-730b-4a26-a661-b2d2dda74534"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1223), 0, 0, "What countries have the highest fertility rate (2019)", "Top 10" },
                    { new Guid("9429778e-df46-4c10-a0d4-80fecbfdf3f9"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1228), 0, 0, "What countries have the lowest fertility rate (2019)", "Top 10" },
                    { new Guid("62732694-8646-4ded-a4ac-c51dfce4dfc6"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1232), 0, 0, "What countries have won the most gold medals at the olympics", "Top 10" },
                    { new Guid("db0edb42-f12b-432f-82ec-5d16a51f13f0"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1237), 0, 0, "What countries have the most amount of total immigrants", "Top 10" },
                    { new Guid("03744a50-cdd5-43c1-898d-b69df8168820"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1241), 0, 0, "What countries have the most percentage of immigrants", "Top 10" },
                    { new Guid("961761d2-f15d-4853-b8f9-91b9745be1b8"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1246), 0, 0, "What are the countries that drink the most beer per capita", "Top 10" },
                    { new Guid("4cfea5e6-dec6-40ea-8d7e-6f8034a45b82"), 4, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1250), 0, 0, "What are the countries with the most unesco world heritage sites", "Top 10" },
                    { new Guid("94e5f344-ef61-44c6-b209-9b805ca42880"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1255), 0, 0, "What are the most visited countries in the world (2019)", "Top 10" },
                    { new Guid("3e7b6791-8e14-4284-8201-87d7ddc0850b"), 2, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1259), 0, 0, "What countries have the most billionaires (2021)", "Top 10" },
                    { new Guid("f6d70c09-f3a9-4c9e-8baf-808916af4291"), 2, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1266), 0, 0, "What countries have the most millionaires (2021)", "Top 10" },
                    { new Guid("f1b44064-927d-45bf-9fe4-14c2d98d774c"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1210), 0, 0, "What are the countries with the oldest median age (2020)", "Top 10" },
                    { new Guid("e75284fe-a777-4d85-aad5-e68b817b2d50"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1205), 0, 0, "What are the countries with the youngest median age (2020)", "Top 10" },
                    { new Guid("00437064-4748-470c-b77e-046703a2a19a"), 6, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1200), 0, 0, "What are the newest countries in the world", "Top 10" },
                    { new Guid("1f56b20c-54b1-40a3-9b60-c510f27912ae"), 6, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1196), 0, 0, "What are the first countries if you order them alphabetically (A-Z)", "Top 10" },
                    { new Guid("6e9f33c2-9bd1-4c4d-b508-c09fd13d6040"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1191), 0, 0, "What are the most obese countries of the world (2016)", "Top 10" },
                    { new Guid("59dddd6c-7a6e-4e43-9869-088ef430421f"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1187), 0, 0, "Which countries spend the most on their military", "Top 10" },
                    { new Guid("5a563a77-0a11-459a-8162-d886acf1f898"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1182), 0, 0, "What are the least happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("5c08cfa3-a2e0-43bd-a574-184cb3bde2d2"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1177), 0, 0, "What countries have the highest prison population", "Top 10" },
                    { new Guid("26775c7d-97ea-415d-b73c-7629759656cf"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1172), 0, 0, "What countries have the highest GDP per capita", "Top 10" },
                    { new Guid("8630be8d-b3e3-4b1e-babc-207819fe2f46"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1168), 0, 0, "What countries have the highest GDP (nominal)", "Top 10" },
                    { new Guid("962c9cae-4ba2-4506-98c2-1ccdd9535b40"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1161), 0, 0, "What countries have the biggest population of catholics", "Top 10" },
                    { new Guid("98220fe9-135d-423b-ab8f-14d57eafcb38"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1116), 0, 0, "What countries have the biggest population of muslims", "Top 10" },
                    { new Guid("3aa5a782-c701-4a75-b4f0-98bab8d144e2"), 3, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1111), 0, 0, "What are the happiest countries (according to the World Happiness Report in 2020)", "Top 10" },
                    { new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613"), 6, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1104), 0, 0, "What are the smallest countries of the world", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), 4, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1050), 0, 0, "What countries have the biggest population", "Top 10" },
                    { new Guid("00000000-0000-0000-0000-000000000001"), 6, new DateTime(2021, 7, 30, 17, 44, 11, 585, DateTimeKind.Local).AddTicks(5279), 0, 0, "What are the biggest countries of the world", "Top 10" },
                    { new Guid("7301c840-a51f-4e7e-9ead-a5d8e50d510b"), 6, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1270), 0, 0, "Who were the first ten presidents of the United States", "Top 10" },
                    { new Guid("da899e4f-63f2-4560-b693-1c1f13a17d13"), 5, new DateTime(2021, 7, 30, 17, 44, 11, 588, DateTimeKind.Local).AddTicks(1275), 0, 0, "Who were the last ten presidents of the United States", "Top 10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("ec1dc9db-9183-4a29-ad22-b558585dc80c"), "Russia", "17,098,242 Km²", 1, 1, new Guid("00000000-0000-0000-0000-000000000001") },
                    ...
                    { new Guid("b2a69373-8f2b-4f94-89a7-37e0b39ba88c"), "Mexico", "128,932,753", 10, 10, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("a7a249cc-e767-4492-8bb8-acb43b855c12"), "Russia", "145,934,462", 9, 9, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("b9623e6d-8ae1-4e5e-8482-7da2d26daadf"), "Bangladesh", "164,689,383", 8, 8, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("75964002-bef0-4ccd-8ca3-a9d31a2901ba"), "Nigeria", "206,139,589", 7, 7, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("526bcb5b-339a-4e73-8c19-83fd8ce17775"), "Brazil", "212,559,417", 6, 6, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("cb2d4fd8-8a42-4882-b7d1-6193b04ef221"), "Pakistan", "220,892,340", 5, 5, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("2b6d0268-ffb9-4da4-88b5-024f13c68b65"), "Indonesia", "273,523,615", 4, 4, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("a43cd98e-2662-403d-8f97-3ee62f976bb4"), "United States", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("bfa40963-7421-4c2d-9c61-3e144be74fc7"), "US", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("6e942456-a648-4bae-860d-c54c7635eb7a"), "USA", "331,002,651", 3, 3, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("26ad01ed-ff4e-488a-8075-f38e0a53dd1c"), "Vatican City", "0.49 Km²", 1, 1, new Guid("be90a71f-c2ee-4178-96c3-8adb2293b613") },
                    { new Guid("178b7fdd-d1df-4eab-9a87-10947fe02a2f"), "India", "1,380,004,385", 2, 2, new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("1c21d0d2-f2f7-451e-b0ae-1a8560713017"), "Algeria", "2,381,740 Km²", 10, 10, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("c6cbf76b-073d-4b2a-8284-6816d7f52ff9"), "Kazakhstan", "2,724,900 Km²", 9, 9, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("b9398a58-dad4-4e71-878e-9c64883cf0bc"), "Argentina", "2,780,400 Km²", 8, 8, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("ba2e8493-2336-4bcc-b155-6eb128baae77"), "India", "3,287,263 Km²", 7, 7, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("1162f1fb-9b95-42b0-8ae4-4c4744e8b60b"), "Australia", "7,741,220 Km²", 6, 6, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("163c29af-969c-4dd6-b1ae-18f0004b05cb"), "Brazil", "8,515,770 Km²", 5, 5, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("5841bd9e-3f61-40c9-999e-b1077f1680d7"), "China", "9,596,960 Km²", 4, 4, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("f679bb9b-bb3e-429a-9843-50dafd498f6f"), "United States", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("030d7cd1-22a2-4de6-8b9f-81026115d835"), "US", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("a8b8820a-287f-477e-81f8-9e37dfdb15fa"), "USA", "9,833,517 Km²", 3, 3, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("9d9c6d1f-d915-4740-856b-8e71940a4517"), "Canada", "9,984,670 Km²", 2, 2, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("dede4ae2-a7bb-4999-aa5f-1f6926e65f9a"), "China", "1,439,323,776", 1, 1, new Guid("00000000-0000-0000-0000-000000000002") },
